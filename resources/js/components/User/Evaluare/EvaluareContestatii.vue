    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="container mt-4 container-angajati">
                <div class="row">
                    <div class="col-12 info-col-row text-center">
                        Vizualizare contestatii evaluare
                    </div>
                </div>
                <div class="row">
                    ...
                    <tr v-for="(c, index) in data.calificative">
                        ...
                        <td>
                            <select
                                ...
                                aria-label="Default select example"
                                v-model="data.calificativFinalAprobat"
                            >
...
export default {
    ...
    methods:{
        ...
        async preluareCalificative(){
            this.loading = true;
            await axios.get(`/api/calificative/contestatii/institutie/${this.data.institutie}/specialist`, {
                headers:{
                    ContentType: 'application/json',
        ...
        async aprobareCalificativ(id){
            ...
            await axios.put(`/api/calificative/aprobare`, {
                ...
                calificativFinalAprobat: this.data.calificativFinalAprobat
            }, {
                headers:{
                    ContentType: 'application/json',
                    Authorization : 'Bearer ' + this.data.token
