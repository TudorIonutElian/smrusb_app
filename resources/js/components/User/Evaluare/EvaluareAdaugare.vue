                    ...
                    <div class="col-12">
                        <table class="table">
                            ...
                            <tr class="bg-success text-white">
                                ...
                                <th scope="col">Adauga Calificativ</th>
                            </tr>
                            </thead>
                            ...
                            <tr v-for="(angajat, index) in lista_angajati">
                                ...
                                <td>
                                    <span v-if="angajat.angajat_status != 0">{{ angajat.angajat_functie ? angajat.angajat_functie: 'Nu este numit.' }}</span>
                                    <span class="contract_incetat" v-if="angajat.angajat_status == 0">Contract incetat</span>
                                </td>
                                <td v-if="angajat.angajat_status !== 0 &&  angajat.angajat_functie != null">
                                    <a
                                        :href="'/user/evaluare/adaugare/' + angajat.angajat_id"
                                        class="btn btn-sm btn-secondary btn-show"
                                    >
                                        Adauga Evaluare</a>
                                </td>
                                <td v-else>
                                    <button class="btn btn-sm btn-danger" disabled>Adauga Evaluare</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
