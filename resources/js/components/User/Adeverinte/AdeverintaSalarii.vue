                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row" id="adeverint_text">
                            <div class="col-text-general">
                                ...
                                fiind asigurat în sistemul asigurarilor sociale de stat pentru care se platesc contributii sociale.
                                Contributiile au fost platite de catre angajator / angajatori, incepand cu data angajarii pana in prezent.
                                <div class="my-1">În perioada angajarii, a beneficiat de urmatoarele salarii:</div>
                                <table class="table table-salarii">
                                    <thead>
...
export default {
    ...
    methods:{
        ...
        eliberareAdeverinta(id){
            ...
            axios.get(`/api/salarizare/${this.lista_angajati_filtrat[this.angajat_id].angajat_cnp}`, {
                headers:{
                    ContentType: 'application/json',
                    Authorization : 'Bearer ' + localStorage.getItem('token')
                }
            }).then(async (response) => {
                this.lista_salarii = response.data;
                Vue.$toast.open({
...
.table-salarii tbody th,
.table-salarii tbody td{
    padding: 0!important;
}
</style>
