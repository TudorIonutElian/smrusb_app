                ...
                <div class="row">
                    <div class="col-12 d-flex mb-2">
                        <div class="d-flex mb-3">
                            ...
                            <div class="d-flex-inner m-2">
                                <label for="institutie">Selectati luna calendaristica</label>
                                <select
                                    id="luna"
                                    class="form-control form-select m-2"
                                    aria-label="Default select example"
                                ...
                                >
                                    <option value="01">01 - Ianuarie</option>
                                    <option value="02">02 - Februarie</option>
                                    <option value="03">03 - Martie</option>
                                    <option value="04">04 - Aprilie</option>
                                    <option value="05">05 - Mai</option>
                                    <option value="06">06 - Iunie</option>
                                    <option value="07">07 - Iulie</option>
                                    <option value="08">08 - August</option>
                                    <option value="09">09 - Septembrie</option>
                    ...
                    <div class="col-12 my-3">
                        <table class="table table-striped" id="salariiGenerate">
                            ...
                            <tr v-if="(this.data.salarii == null) || (this.data.salarii != null && this.data.salarii.length == 0) ">
                                <td colspan="10" class="text-center">Nu exista salarii pentru luna selectata.</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
export default {
    ...
    methods:{
        ...
        async preluareSalarii(){
            this.loading = true;
            await axios.get(`/api/salarizare/${this.data.institutie}/lunar/${this.data.luna}`, {
                headers:{
                    ContentType: 'application/json',
                    Authorization : 'Bearer ' + this.data.token
                }
            }).then(response => {
                    this.data.salarii = response.data.data
                    this.loading = false;
